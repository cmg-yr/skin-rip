        ...
        var d = {},
            ...
            f = {
                ...
                initSlider: function(b) {
                    c(a.SITE.settings.sliderSelector).dfoSlider({
                        endlessLoop: !0,
                        selectable: !0,
                        selectableClass: "upsell" === b ? "tickbox" : "",
                        onInit: function(a) {
                            "upsell" === b ? a.find(".dotlist > li:first .dot").trigger("click") : "order" === b && (a.find(".dotlist .active").length || a.find(".dotlist > li:first .dot").trigger("click"))
                        },
                        onSelectedProduct: function(d) {
                            var e = c(".order-form-column");
                            c("#termsAgree").prop("checked", !0), "upsell" === b ? (d.find(".select-button").removeClass("disabled"), d.siblings().find(".select-button").addClass("disabled")) : "order" === b && (f.updatePackageName(d.find(".title").text(), c(".package-name")), a.setTimeout(function() {
                                f.scrollToEl(c(".payment"))
                            }, 300), e.removeClass("trial continuity hard"), d.hasClass("trial") && (d.hasClass("continuity") ? e.addClass("trial continuity") : d.hasClass("hard") && e.addClass("trial hard")))
                        }
                    })
                },
                initUnveil: function() {
    ...
    function(a, b, c) {
        ...
        var d = a.SITE.helpers,
            ...
            g = {
                ...
                landing: {
                    init: function() {
                        d.initUnveil(), d.setDatesInDOM(), e.initForm(c("#register-form"), "registerForm"), d.fillCanvasInfo(), f.hookRunner("landing"), d.updateCountry(a.SITE.settings.locale, c(".country")), d.setClockStopwatch(), d.trackScroll(), d.preventEmptyHref(), d.bindScrollButtons(), d.loadStates(), new WOW({
                            offset: 20
                        }).init();
                        var g = {
                                endlessLoop: !0,
